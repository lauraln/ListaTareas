...
class AlarmaReceiver_old  : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        //Obtenemos el texto
        val contenido = intent?.getStringExtra("texto") ?: "No ha llegado bien el texto de la tarea."
        ...
        val notificacion = NotificationCompat.Builder(context!!, ID_CANAL)
            ...
            .setSmallIcon(R.drawable.ic_check_all)
